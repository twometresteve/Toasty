...
export default function Game(game:GameTyping){
  ...
  this.helperSlurrySource = gameSettings?.helperSlurrySource._text == undefined ? 1 : utility.formatNumber(gameSettings.helperSlurrySource._text as number, 0, '')
  this.helperManureSource = gameSettings?.helperManureSource._text == undefined ? 1 : utility.formatNumber(gameSettings.helperManureSource._text as number, 0, '')
