import { GameTyping } from 'typings/model';
import utility from '../libraries/utility';

export default function Game(game:GameTyping){
  ...
  this.money = gameStatistics.money._text == undefined ? '0 $' : utility.formatNumber(gameStatistics.money._text as number, 0, ' $')
  ...
  this.helperBuySeeds = (gameSettings.helperBuySeeds._text) == undefined ? 'true' : (gameSettings.helperBuySeeds._text)
  this.helperBuyFertilizer = (gameSettings.helperBuyFertilizer._text) == undefined ? 'true' : (gameSettings.helperBuyFertilizer._text)
  this.helperSlurrySource = gameSettings.helperSlurrySource._text == undefined ? 2 : utility.formatNumber(gameSettings.helperSlurrySource._text as number, 0, '')
  this.helperManureSource = gameSettings.helperManureSource._text == undefined ? 2 : utility.formatNumber(gameSettings.helperManureSource._text as number, 0, '')
